...
const SkillSelect = React.forwardRef(
  (
    {
      value,
      onChange,
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative transition-[height] ease-in-out delay-50",
            open && "h-[150px]",
            !open && "h-0"
          )}
        >
          {open && (
            <CommandList
              className="absolute top-1 z-10 w-full rounded-md border bg-black-1 text-popover-foreground shadow-md outline-none animate-in"
              onMouseLeave={() => {
